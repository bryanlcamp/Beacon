...
- **[Risk Management](risk-management.md)** - Built-in controls and custom rules
- **[Performance Tuning](performance.md)** - Optimizing for low latency
...
**New to Beacon?** Start with the [Quick Start Guide](../README.md#quick-start)

**Need more control?** Check out [Advanced Configuration](advanced-usage.md)

**Having issues?** See [Troubleshooting](troubleshooting.md)

**Want to extend Beacon?** Read [Architecture](architecture.md) and [Extending Beacon](extending.md)
