#!/usr/bin/env python3
"""
Beacon Application Build Script - Client Algorithm
...
APP_TARGETS = ["ClientAlgorithm", "ClientAlgorithmHft", "AlgoTwap", "AlgoTwapProtocol", "MarketDataReceiver"]
...
def build_mode(mode, run_tests=False):
    ...
    cmake_args.append(f"-DBUILD_TESTING={'ON' if run_tests else 'OFF'}")
