 ...
 * NSDQ OUCH v5 message structs for direct binary parsing.
 *
 * These structs represent the raw binary message formats for NSDQ OUCH v5.0.
 * Field order, types, and alignment must match the official NSDQ specification.
 ...
 * For details, see NSDQ OUCH v5.0 Specification.
 */
...
namespace beacon::nsdq::execution {
