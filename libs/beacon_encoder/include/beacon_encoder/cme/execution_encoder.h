 ...
 * Purpose:      CME iLink3 execution encoder
 * Author:       Bryan Camp
 * =============================================================================
 */
...
// CME Execution Encoder (iLink3) - zero overhead
...
public:
    ...
    static constexpr size_t GetMaxMessageSize() noexcept { return 128; }
...
template<>
struct EncoderFactory<beacon::exchange::ExchangeType::CME, InternalExecutionMessage> {
    using type = EncoderDispatcher<cme::ExecutionEncoder, InternalExecutionMessage>;
